...
from app.routes.bio import bio_bp
...
app.register_blueprint(services_bp, url_prefix='/dashboard/services')
app.register_blueprint(bio_bp, url_prefix='/dashboard/bio')
